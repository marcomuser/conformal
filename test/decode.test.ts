...
describe("decode", () => {
  it("should handle simple key-value pairs", () => {
    ...
    expect(data).toEqual({ name: "John Doe", age: "30", file });
  });
  ...
  it("should handle arrays", () => {
    ...
    const data = decode(formData);
    expect(data).toEqual({ items: ["apple", "banana"] });
  });
  ...
  it("should handle array with non-consecutive indexes", () => {
    ...
    const data = decode(formData);
    expect(data).toEqual({ items: ["apple", undefined, "orange"] });
  });
  ...
  it("should handle duplicate keys as an array of values", () => {
    ...
    const data = decode(formData);
    expect(data).toEqual({ item: ["apple", "banana", "orange"] });
  });
  ...
  it("should handle duplicate keys in nested objects", () => {
    ...
    const data = decode(formData);
    expect(data).toEqual({ items: { name: ["apple", "banana"] } });
  });
