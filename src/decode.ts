...
import type { AnyRecord, InputValue } from "./types.js";

/**
 * Decodes a `FormData` object into a structured object with typed values.
 *
 ...
 *
 * decode<{ name: string; age: string; hobbies: string[] }>(formData);
 * // Returns { name: 'John Doe', age: '30', hobbies: ['Music', 'Coding'] }
 * ```
 */
export function decode<FormValues = UnknownRecord>(
  formData: FormData,
